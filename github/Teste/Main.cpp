...
int main(){
    ...
    if(bot->connect()){ 
	    while(bot->isConnected()){
	    		...
	    		if(numeroCurvas == 0 && direita > 0.115 && frente < 0.115 && !fezCurva)
	    			viraDireita(bot, &fezCurva, &numeroCurvas);
	    		else if(numeroCurvas == 0 && direita < 0.115 && frente < 0.115 && esquerda > 0.115 && !fezCurva)
	    			viraEsquerda(bot, &fezCurva, &numeroCurvas);
	    		else if(numeroCurvas == 0 && direita < 0.115 && frente < 0.115 && esquerda < 0.115 && !fezCurva)
	    			viraAtras(bot, &fezCurva, &numeroCurvas);
	    		if(numeroCurvas == 1 && esquerda > 0.115 && !fezCurva)
	    			viraEsquerda(bot, &fezCurva, &numeroCurvas);
	    		if(numeroCurvas == -1 && direita > 0.115 && !fezCurva)
	    			viraDireita(bot, &fezCurva, &numeroCurvas);
	    		else if(numeroCurvas == -1 && direita < 0.115 && frente < 0.115 && esquerda > 0.115 && !fezCurva)
	    			viraEsquerda(bot, &fezCurva, &numeroCurvas);
	    		if((numeroCurvas == -2 || numeroCurvas == 2) && frente < 0.115 && direita > 0.115 && !fezCurva)
	    			viraDireita(bot, &fezCurva, &numeroCurvas);
	    		}while(!fezCurva);
